            ...
            steps {
                script {
                    withKubeConfig([credentialsId: 'kubeconfig']) {  // Use Kubernetes configuration for deployment
                        sh '''sed -i "s|yasiru1997/numeric-app2:PLACEHOLDER|yasiru1997/numeric-app2:${GIT_COMMIT}|g" k8s_deployment_service.yaml'''  // Replace placeholder with actual Docker image tag
